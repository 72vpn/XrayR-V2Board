...
```
wget https://cdn.jsdelivr.net/gh/72vpn/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
```

3. 修改下面链接的用户名 `missuo` 为你自己的GitHub用户名，完成配置一键安装脚本命令。
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/72vpn/XrayR-V2Board/install.sh)
```
